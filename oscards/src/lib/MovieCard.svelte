...
>
	<button
		class="material-symbols-outlined absolute top-6 right-7 h-7 w-7 scale-150 rounded-md border border-yellow-400 text-yellow-400 transition-transform hover:scale-200 hover:cursor-pointer"
